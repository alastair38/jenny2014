...
$args['fields'][] = array('type' => 'post_type',
                          'label' => 'Content Type',    
                          'format' => 'checkbox',
                          'values' => array('articles' => 'Online Articles', 'post' => 'Posts', 'research' => 'Research', 'resources' => 'Resources', 'videos' => 'Videos')
                         );
...
<h4 class="archive-title">Looks like you've visited an old link!!</h4>
<?php	
if ( have_posts() ): 
