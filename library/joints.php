...
function joints_scripts_and_styles() {
  ...
  if (!is_admin()) {
   ...
   // loads jQuery 2.1.0
    ...
    // adding Responsive Slides script file in the footer
    wp_enqueue_script( 'responsiveslides-js', get_template_directory_uri() . '/library/js/responsiveslides.js', array( 'jquery' ), '', true );
      
 // adding Flickerplate script file in the footer
  //  wp_enqueue_script( 'hammer-js', get_template_directory_uri() . '/library/js/hammer.js', array( 'jquery' ), '', true );
    ...
    wp_enqueue_style( 'foundation-icons', get_stylesheet_directory_uri() . '/library/css/icons/foundation-icons.css', array(), '', 'all' );
     ...
     // register Flickerplate Theme stylesheet
    wp_enqueue_style( 'flickerplate-stylesheet', get_stylesheet_directory_uri() . '/library/css/flickerplate.theme.css', array(), '', 'all' );
